...
if ($col_width === false)
{
    ...
    {
        die("To calculate the column width, I need both grid width and number of columns.");
    }
...
if ($columns === false)
{
    ...
    {
        die("To calculate the number of columns, I need both grid and column width.");
    }
 ...
 * WIDTH.....:    <?=$width.$unit.nl;?>
 * COLUMNS...:    <?=$columns.nl;?>
 * C_WIDTH...:    <?=$col_width.$unit.nl;?>
 * LAYOUT....:    <?=ucfirst($layout).nl;?>
 * H-ALIGN...:    <?=ucfirst($halign).nl;?>
 * SPACING...:    <?=ucfirst($spacing);?> <?=ucfirst($spacing_sides);?> [<?=($margin + $padding).$unit;?>]
 * GUTTER....:    <?=($gutter) ? "Removed $cut$unit\n" : "Present\n";?>
 * SPANNING..:    <?=ucfirst($spanning).nl;?>
 *
